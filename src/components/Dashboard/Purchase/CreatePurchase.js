        ...
        <div className="max-w-5xl mx-auto p-6 space-y-6">
            <div className="bg-white shadow rounded p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        <label className="text-sm font-medium">Warehouse/Branch <span className="text-red-500">*</span></label>
                        <select className="w-full mt-1 border rounded p-2">
                            <option>Ahmed LLC</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label className="text-sm font-medium">Chalan No</label>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                    <div className="bg-white p-6 rounded shadow-md w-full max-w-md">
                        ...
                        <div>
                            ...
                            <div className="mb-3">
                                <label className="block text-sm mb-1">Company Name <span className="text-red-500">*</span></label>
                                <input
                                    id="supplier-company"
                                    type="text"
                                    className="w-full border rounded p-2"
                            ...
                            <tr key={index} className="text-center">
                                ...
                                <td className="border p-1">
                                    <input
                                        ...
                                        placeholder="dd/mm/yyyy"
                                        value={item.expDate}
                                        onChange={(e) => updateItemField(index, 'expDate', e.target.value)}
                                        onBlur={(e) => {
                                            ...
                                            if (!isNaN(dateObj)) {
                                                ...
                                                updateItemField(index, 'expDate', formatted);
                                            }
                                        }}
                                    />
                                </td>
